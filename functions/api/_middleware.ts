 ...
 */
async function resolveUser(db: D1Database, identity: AccessIdentity): Promise<AppUser | null> {
  ...
  // The very first person to sign in owns the workspace; everyone after is a
  // member, so an invited guest cannot land straight into admin.
